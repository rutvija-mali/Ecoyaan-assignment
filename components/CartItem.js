...
export default function CartItem({ item }) {
    ...
    return (
        <div className="flex items-center gap-6 p-5 sm:p-7 mx-2 sm:mx-3 bg-white rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow duration-200">
            {/* Product Image */}
